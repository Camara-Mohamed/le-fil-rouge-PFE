    ...
    >
        ...
        <button type="button" wire:click="close" class="absolute top-4 right-4 text-dark-mid hover:text-dark transition" aria-label="Fermer">
            ...
            <div class="flex flex-col items-center gap-4 w-full">
                <h2 class="font-sans font-black text-3xl text-dark text-center">{{ __('modals/members.delete_title') }}</h2>
            </div>

            <p class="font-serif text-base text-center">{{ __('modals/members.delete_message') }}</p>
