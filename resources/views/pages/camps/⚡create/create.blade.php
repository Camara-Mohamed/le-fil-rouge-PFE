...
<div>
    ...
    <a href="{{ route('public.camps.index', ['locale' => app()->getLocale()]) }}">← Retour</a>
    ...
    <form wire:submit="save">
        ...
        <div>
            ...
            <input type="number" wire:model.live="form.participants" min="0">
        ...
        <button type="submit">Créer la camp</button>
    </form>
</div>
