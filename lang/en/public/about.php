...
return [
    ...
    'stat_years' => 'Years of engagement in Belgium',
    'stat_trainings' => 'Trainings organised',
    'stat_camps' => 'Camps and stays',
    ...
    'faq_3_a' => 'Most of our trainings are available at a reduced rate or free for members. The exact cost is shown on each training page.',
    'faq_4_q' => 'Do I need to be a member to join a camp?',
    'faq_4_a' => 'No, camps are open to everyone. Being a member gives you access to preferential rates and member-only activities.',
    'faq_5_q' => 'Where do activities take place?',
    'faq_5_a' => 'Our trainings and camps take place in various Belgian provinces. The exact location is always specified in the activity listing.',
    'faq_6_q' => 'How do I cancel a registration?',
    'faq_6_a' => 'You can cancel from your personal space up to 7 days before the activity starts. After that, contact us directly via the contact form.',
];
